  ...
  return (
    ...
    >
      ...
      <div className="glass-card space-y-4 p-6 md:p-8">
        ...
        <a href="https://meet.google.com/dtm-oxkq-oeh " target="_blank" rel="noreferrer" className="btn-primary inline-flex items-center gap-2">Entrepreneurship and Business Development link <span aria-hidden="true">{'->'}</span></a> {/* TODO: Add the image here for the Entrepreneurship and Business Development course */} <img src={findAssetUrl('entrepreneurshipAndBusinessDevelopment')} alt="Entrepreneurship and Business Development" className="w-10 h-10" /> 
